                        ...
                        builder: (context) => MultiBlocProvider(
                          providers: [
                            BlocProvider<GetAnnonceClient.GetAnnonceClientBloc>(
                                create: (context) => GetAnnonceClient
                                    .GetAnnonceClientBloc(
                                        annonceRepo:
                                            FirebaseAnnonceClientRepo())
                                  ..add(GetAnnonceClient.GetAnnonceClientByUser(
                                      state.myUser!))),
                            BlocProvider<
                                    GetAnnonceTransporteur
                                    .GetAnnonceTransporteurBloc>(
                                create: (context) => GetAnnonceTransporteur
                                    .GetAnnonceTransporteurBloc(
                                        annonceRepo:
                                            FirebaseAnnonceTransporteurRepo())
                                  ..add(GetAnnonceTransporteur
                                      .GetAnnonceTransporteurByUser(
                                          state.myUser!))),
                          ],
                          child: Profile(state.myUser!),
                        ),
                      )
                    );
                },
