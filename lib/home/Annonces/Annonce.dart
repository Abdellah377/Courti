...
class _AnnonceState extends State<Annonce> {
  ...
  List<String> listOfValueClient = ['Titre','Ville_depart','Ville_darrive','Date_depart','Date_darrive','tonnage','prix','TypeMarchandise',];
  List<String> listOfValueTransp = ['Titre','Ville_depart','Ville_darrive','Date_depart','Date_darrive','charge','prix','NbreVehicule',];
                              ...
                              Expanded(
                                ...
                                child: Container(
                                  ...
                                  child: DropdownButtonFormField(
                                    ...
                                    items: listOfValueClient.map((String val) {
                                ...
                                child: Container(
                                    ...
                                    child: IconButton(
                                      ...
                                      onPressed: () {
                                        PersistentNavBarNavigator.pushNewScreen(
                                          context,
                                          screen: SearchAnnonce_Screen(argsControllerClient, valueControllerClient.text, "Client"),
                                          withNavBar: false,
                                        ...
                                        Column(
                                          ...
                                          children: [
                                            ...
                                            Text(DateFormat("yyyy-MM-dd HH:mm")
                                                .format(state.annonces[i].Created_at)),
                                          ],
                                        ),
                                      ],
                                    ),
                                      ...
                                      child: MaterialButton(
                                        onPressed: () {
                                          Navigator.push(
                                              context,
                                              MaterialPageRoute(
                                                  builder: (context) => Details_Client(
                                                      state.annonces[i])));
                                        },
                                            ...
                                            Row(
                                              children: [
                                                Expanded(
                                                  child: Center(
                                                      child: Text(state
                                                          .annonces[i].Ville_depart)),
                                                ),
                                                Expanded(
                                                  child: Center(
                                                      child: Text(state
                                                          .annonces[i].Ville_darrive)),
                                                ),
                                              ],
                                            ),
                                            Container(
                                            ...
                                            Row(
                                              children: [
                                                Expanded(
                                                  child: Center(
                                                      child: Text(
                                                    state.annonces[i].TypeMarchandise,
                                                    maxLines: 2,
                                                  )),
                                                ),
                                                Expanded(
                              ...
                              Expanded(
                                ...
                                child: Container(
                                  ...
                                  child: DropdownButtonFormField(
                                    ...
                                    items: listOfValueTransp.map((String val) {
                                      return DropdownMenuItem(
                                        value: val,
                                        child: Text(val),
                                      );
                                ...
                                child: Container(
                                    ...
                                    child: IconButton(
                                      ...
                                      onPressed: () {
                                        PersistentNavBarNavigator.pushNewScreen(
                                          context,
                                          screen: SearchAnnonce_Screen(argsControllerTransp,valueControllerTransp.text,"Transporteur"),
                                          withNavBar: false,
                                          pageTransitionAnimation:
                                          PageTransitionAnimation.cupertino,
                                        );
